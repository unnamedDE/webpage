...
function generateMcscript() {
 ...
 Item11I = "";
  ...
  if (item0_id.value != "")
    {
        Item0 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b,id:\"" + item0_id.value + "\",tag:{" + item0_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item0I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b,id:\"" + item0_id.value + "\",tag:{" + item0_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item0 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b}]}'";
        Item0I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b}]}'";
    }
    if (item1_id.value != "")
    {
        Item1 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b,id:\"" + item1_id.value + "\",tag:{" + item1_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item1I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b,id:\"" + item1_id.value + "\",tag:{" + item1_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item1 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b}]}'";
        Item1I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b}]}'";
    }
    if (item2_id.value != "")
    {
        Item2 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b,id:\"" + item2_id.value + "\",tag:{" + item2_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item2I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b,id:\"" + item2_id.value + "\",tag:{" + item2_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item2 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b}]}'";
        Item2I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b}]}'";
    }
    if (item3_id.value != "")
    {
        Item3 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b,id:\"" + item3_id.value + "\",tag:{" + item3_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item3I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b,id:\"" + item3_id.value + "\",tag:{" + item3_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item3 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b}]}'";
        Item3I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b}]}'";
    }
    if (item4_id.value != "")
    {
        Item4 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b,id:\"" + item4_id.value + "\",tag:{" + item4_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item4I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b,id:\"" + item4_id.value + "\",tag:{" + item4_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item4 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b}]}'";
        Item4I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b}]}'";
    }
    if (item5_id.value != "")
    {
        Item5 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b,id:\"" + item5_id.value + "\",tag:{" + item5_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item5I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b,id:\"" + item5_id.value + "\",tag:{" + item5_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item5 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b}]}'";
        Item5I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b}]}'";
    }
    if (item6_id.value != "")
    {
        Item6 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b,id:\"" + item6_id.value + "\",tag:{" + item6_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item6I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b,id:\"" + item6_id.value + "\",tag:{" + item6_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item6 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b}]}'";
        Item6I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b}]}'";
    }
    if (item7_id.value != "")
    {
        Item7 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b,id:\"" + item7_id.value + "\",tag:{" + item7_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item7I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b,id:\"" + item7_id.value + "\",tag:{" + item7_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item7 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b}]}'";
        Item7I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b}]}'";
    }
    if (item8_id.value != "")
    {
        Item8 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b,id:\"" + item8_id.value + "\",tag:{" + item8_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item8I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b,id:\"" + item8_id.value + "\",tag:{" + item8_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item8 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b}]}'";
        Item8I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b}]}'";
    }
    if (item9_id.value != "")
    {
        Item9 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b,id:\"" + item9_id.value + "\",tag:{" + item9_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item9I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b,id:\"" + item9_id.value + "\",tag:{" + item9_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item9 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b}]}'";
        Item9I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b}]}'";
    }
    if (item10_id.value != "")
    {
        Item10 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b,id:\"" + item10_id.value + "\",tag:{" + item10_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item10I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b,id:\"" + item10_id.value + "\",tag:{" + item10_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item10 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b}]}'";
        Item10I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b}]}'";
    }
    if (item11_id.value != "")
    {
        Item11 = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b,id:\"" + item11_id.value + "\",tag:{" + item11_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
        Item11I = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b,id:\"" + item11_id.value + "\",tag:{" + item11_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]}'";
    }
    else
    {
        Item11 = "!'block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b}]}'";
        Item11I = "'block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b}]}'";
    }
...
function generateMcfunction() {
 ...
 Item11I = "";
  ...
  if (item0_id.value != "")
    {
        console.log(item0_nbt.value, item0_nbt.value.replace(/\\\"/g,"\\\\\""));
        Item0 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b,id:\"" + item0_id.value + "\",tag:{" + item0_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item0I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b,id:\"" + item0_id.value + "\",tag:{" + item0_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item0 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b}]} ";
        Item0I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:1b}]} ";
    }
    if (item1_id.value != "")
    {
        Item1 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b,id:\"" + item1_id.value + "\",tag:{" + item1_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item1I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b,id:\"" + item1_id.value + "\",tag:{" + item1_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item1 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b}]} ";
        Item1I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b}]} ";
    }
    if (item2_id.value != "")
    {
        Item2 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b,id:\"" + item2_id.value + "\",tag:{" + item2_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item2I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b,id:\"" + item2_id.value + "\",tag:{" + item2_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item2 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b}]} ";
        Item2I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b}]} ";
    }
    if (item3_id.value != "")
    {
        Item3 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b,id:\"" + item3_id.value + "\",tag:{" + item3_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item3I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b,id:\"" + item3_id.value + "\",tag:{" + item3_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item3 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b}]} ";
        Item3I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:10b}]} ";
    }
    if (item4_id.value != "")
    {
        Item4 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b,id:\"" + item4_id.value + "\",tag:{" + item4_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item4I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b,id:\"" + item4_id.value + "\",tag:{" + item4_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item4 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b}]} ";
        Item4I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:11b}]} ";
    }
    if (item5_id.value != "")
    {
        Item5 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b,id:\"" + item5_id.value + "\",tag:{" + item5_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item5I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b,id:\"" + item5_id.value + "\",tag:{" + item5_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item5 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b}]} ";
        Item5I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:12b}]} ";
    }
    if (item6_id.value != "")
    {
        Item6 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b,id:\"" + item6_id.value + "\",tag:{" + item6_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item6I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b,id:\"" + item6_id.value + "\",tag:{" + item6_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item6 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b}]} ";
        Item6I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:19b}]} ";
    }
    if (item7_id.value != "")
    {
        Item7 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b,id:\"" + item7_id.value + "\",tag:{" + item7_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item7I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b,id:\"" + item7_id.value + "\",tag:{" + item7_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item7 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b}]} ";
        Item7I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:20b}]} ";
    }
    if (item8_id.value != "")
    {
        Item8 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b,id:\"" + item8_id.value + "\",tag:{" + item8_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item8I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b,id:\"" + item8_id.value + "\",tag:{" + item8_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item8 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b}]} ";
        Item8I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:21b}]} ";
    }
    if (item9_id.value != "")
    {
        Item9 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b,id:\"" + item9_id.value + "\",tag:{" + item9_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item9I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b,id:\"" + item9_id.value + "\",tag:{" + item9_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item9 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b}]} ";
        Item9I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:5b}]} ";
    }
    if (item10_id.value != "")
    {
        Item10 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b,id:\"" + item10_id.value + "\",tag:{" + item10_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item10I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b,id:\"" + item10_id.value + "\",tag:{" + item10_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item10 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b}]} ";
        Item10I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:14b}]} ";
    }
    if (item11_id.value != "")
    {
        Item11 = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b,id:\"" + item11_id.value + "\",tag:{" + item11_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
        Item11I = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b,id:\"" + item11_id.value + "\",tag:{" + item11_nbt.value.replace(/\\\"/g,"\\\\\"") + "}}]} ";
    }
    else
    {
        Item11 = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b}]} ";
        Item11I = "if block ~ ~ ~ minecraft:barrel{Items:[{Slot:23b}]} ";
    }
    ...
    if(itemout0_id.value != "")
    {
        outputUp = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot: 7b,Count:" + itemout0_count.value + "b,id:\"" + itemout0_id.value + "\"" + ItemOutNbtUp.replace(/\\\"/g,"\\\\\"") + "}]}";
    }
    var outputMain = "";
    if (itemout1_id.value != "")
    {
        outputMain = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot: 16b,Count:" + itemout1_count.value + "b,id:\"" + itemout1_id.value + "\"" + ItemOutNbtMain.replace(/\\\"/g,"\\\\\"") + "}]}";
    }
    var outputDown = "";
    if (itemout2_id.value != "")
    {
        outputDown = "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot: 25b,Count:" + itemout2_count.value + "b,id:\"" + itemout2_id.value + "\"" + ItemOutNbtDown.replace(/\\\"/g,"\\\\\"") + "}]}";
    }

  document.getElementById('output_mcfunction_0').innerHTML = "execute if entity @s[tag=!ac_lib_advanced_crafter_crafted] " + Item0.replace(/,tag:{}/g,"") + Item1.replace(/,tag:{}/g,"") + Item2.replace(/,tag:{}/g,"") + Item3.replace(/,tag:{}/g,"") + Item4.replace(/,tag:{}/g,"") + Item5.replace(/,tag:{}/g,"") + Item6.replace(/,tag:{}/g,"") + Item7.replace(/,tag:{}/g,"") + Item8.replace(/,tag:{}/g,"") + Item9.replace(/,tag:{}/g,"") + Item10.replace(/,tag:{}/g,"") + Item11.replace(/,tag:{}/g,"") + "unless block ~ ~ ~ minecraft:barrel{Items:[{Slot: 7b}]} unless block ~ ~ ~ minecraft:barrel{Items:[{Slot: 16b}]} unless block ~ ~ ~ minecraft:barrel{Items:[{Slot: 25b}]} run function " + txtFunctionPath + "/1&#13;&#10;&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] " + Item0.replace(/,tag:{}/g,"") + Item1.replace(/,tag:{}/g,"") + Item2.replace(/,tag:{}/g,"") + Item3.replace(/,tag:{}/g,"") + Item4.replace(/,tag:{}/g,"") + Item5.replace(/,tag:{}/g,"") + Item6.replace(/,tag:{}/g,"") + Item7.replace(/,tag:{}/g,"") + Item8.replace(/,tag:{}/g,"") + Item9.replace(/,tag:{}/g,"") + Item10.replace(/,tag:{}/g,"") + Item11.replace(/,tag:{}/g,"") + outputUp + outputMain + outputDown + " run function " + txtFunctionPath + "/2&#13;&#10;&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item0I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item1I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item2I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item3I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item4I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item5I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item6I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item7I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item8I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item9I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item10I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3&#13;&#10;execute if entity @s[tag=ac_lib_advanced_crafter_crafted_" + txtRecipeId + "] if block ~ ~ ~ minecraft:barrel " + Item11I.replace(/,tag:{}/g,"") + "run function " + txtFunctionPath + "/3";
