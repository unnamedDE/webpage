...
window.addEventListener('load', () => {
  if(document.querySelector('.contact-button'))
    document.querySelector('.contact-button').innerHTML = "<i class=\"fas fa-comment-alt\" id=\"contact-icon\"></i><a hidden class=\"contact-point\" href=\"https://unnamedde.tk/discord\" target=\"_blank\" title=\"Discord\"><i class=\"fab fa-discord\"></i></a><a hidden class=\"contact-point\" href=\"mailto:admin@unnamedDE.tk?subject=Contact\" title=\"Email\"><i class=\"fas fa-envelope\"></i></a><a hidden class=\"contact-point\" href=\"https://unnamedde.tk/curseforge\" target=\"_blank\" title=\"Curseforge\"><div></div></a><a hidden class=\"contact-point\" href=\"https://unnamedde.tk/planetminecraft\" target=\"_blank\" title=\"Planetminecraft\"><div></div></a><a hidden class=\"contact-point\" href=\"https://unnamedde.tk/github\" target=\"_blank\" title=\"GitHub\"><i class=\"fab fa-github\"></i></a>";
})
window.addEventListener('load', () => {
  if(document.querySelector('.social-button'))
    document.querySelector('.social-button').innerHTML = "<i class=\"fas fa-share-alt\" id=\"social-icon\"></i><a hidden class=\"social-point\" href=\"https://wa.me/?text=" + encodeURIComponent('Check out these cool minecraft online tools made by unnamedDE.\nClick on ' + window.location.href + ' to check out these tools!') + "\" target=\"_blank\" title=\"Whatsapp\"><i class=\"fab fa-whatsapp\"></i></a><a hidden class=\"social-point\" href=\"mailto:?subject=" + encodeURIComponent('Check out these cool minecraft tools I found online!') + "&amp;body=" + encodeURIComponent('Check out these tools made by unnamedDE\nClick on ' + window.location.href) + "\" title=\"Email\"><i class=\"fas fa-envelope\"></i></a><a hidden class=\"social-point\" href=\"https://twitter.com/share?url=" + encodeURIComponent(window.location.href) + "&text=" + encodeURIComponent('Check out these cool minecraft tools I found online') + "\" target=\"_blank\" title=\"Twitter\"><i class=\"fab fa-twitter\"></i></a><a hidden class=\"social-point\" href=\"sms:?body=" + encodeURIComponent('Check out these cool minecraft tools I found online. Click ' + window.location.href + ' to visit the website!') + "\" target=\"_blank\" title=\"SMS\"><i class=\"fas fa-sms\"></i></a><a hidden class=\"social-point\" href=\"https://www.facebook.com/sharer.php?u=" + encodeURIComponent('Check out these cool minecraft tools I found online. Click ' + window.location.href + ' to visit the website!') + "\" target=\"_blank\" title=\"Facebook\"><i class=\"fab fa-facebook\"></i></a>";
})
